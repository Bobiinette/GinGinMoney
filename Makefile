...
SRC = Grille.c Cases.c ComposanteConnexe.c ListeComposanteConnexe.c solveur.c solveur2.c
DOXYSRC = Grille.c Cases.c ComposanteConnexe.c ListeComposanteConnexe.c colorFlood.c solveur.c solveur2.c
OBJ = ${SRC: .c = .o}
